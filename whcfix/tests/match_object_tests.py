...
class MatchTests(unittest.TestCase):
    ...
    def test_isFixture_vs_isResult(self):
        ...
        result = Match(_, _, _, _, 3, 2, _, _, _)
...
# When no time information is available, just use the home sides name
    ...
    def test_sorting2(self):
        m1 = Match(date(2014, 6, 1), time(15, 30), "Venue", "Home", 2, 1,
                   "Away", False, "Mens")
        m2 = Match(date(2014, 6, 1), time(12, 30), "Venue", "Bome", 2, 1,
                   "Away", False, "Mens")
        m3 = Match(date(2014, 6, 1), None, "Venue", "Aome", 2, 1, "Away",
                   False, "Mens")
        matches = [m1, m2, m3]
        matches.sort()
# Nones come first

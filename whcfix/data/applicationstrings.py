...
class ApplicationStrings(object):
    ...
    def __init__(self):
        ...
        self.hContact = "Problems and Improvements"
        self.pContact = "If you'd like to suggest any changes or report any problems please get in touch!"
        self.hFixtures = "View Last Result and Next Fixture"
        self.pFixtures = "See how each Wakefield Side fared last weekend and who they've got coming up this weekend."
